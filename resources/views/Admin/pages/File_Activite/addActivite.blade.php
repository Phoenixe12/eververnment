<div class="modal fade" id="modalFormOrganisteur">
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content ">
            <form id="formOrg" action="{{ route('Activite.store') }}" data-toggle="validator" role="form" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header py-1" style="background-color:#0b440e;">
                    <h4 class="modal-title text-white">Domaine d'activité</h4>
                        ...
                        <div class="row ">
                            <div class="col-sm">
                                <div class="form-group">
                                    <label class="control-label" for="nomActivite">Nom domaine d'activité </label>
