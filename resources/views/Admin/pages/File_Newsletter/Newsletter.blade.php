...
@section('Newsletter')
    ...
    <div class="container mb-3 ">
        <div class="card">
            <div class="card-header" style="background-color:#0b440e;">
                <h2 class="card-title text-white fw-bolder">Newsletter</h2>
            ...
            <div class="card-body">
                <a id="btnModalFormOrganisteur" href="#modalFormOrganisteur" class="btn text-white mb-4"
                    style="background-color:#0b440e;" data-toggle="modal" data-backdrop="static" data-keyboard="false"><i
                        class="fas fa-plus-circle"></i> <span>Ajouter un newsletter</span></a>
    ...
    @include('Admin.pages.File_Newsletter.deleteNewsletter')
    @include('Admin.pages.File_Newsletter.editNewsletter')
    @include('Admin.pages.File_Newsletter.addNewsletter')
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.editbtn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('Newsletter.edit', ':id') }}".replace(':id', id),
                success: function(response) {
                    console.log(response.Newsletter);
                    $('#email').val(response.Newsletter.email);
                    $('#id').val(response.Newsletter.id);
